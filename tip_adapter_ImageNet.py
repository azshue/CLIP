...
def main():
    ...
    # Path for ImageNet
    data_path = "/home/scratch.chaoweix_nvresearch/datasets/ILSVRC2012"
    ...
    images = torchvision.datasets.ImageFolder(os.path.join(data_path, 'val'), transform=preprocess)
    ...
    train_images = torchvision.datasets.ImageFolder(os.path.join(data_path, 'train'), transform=train_tranform)
